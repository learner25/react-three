...
export * from 'three/src/helpers/VertexNormalsHelper';
...
export * from 'three/src/helpers/RectAreaLightHelper';
...
export * from 'three/src/helpers/PositionalAudioHelper';
export * from 'three/src/helpers/FaceNormalsHelper';
...
export * from 'three/src/renderers/webvr/WebVRManager';
